...
# Небольшая задержка перед стартом, чтобы убедиться, что всё инициализировалось
time.sleep(2)
